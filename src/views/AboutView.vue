    ...
    <div class="p-4 sm:p-8">
      ...
      >
        ...
        <div class="space-y-4 leading-relaxed text-gray-700">
          ...
          <p>
            Turns out the site wasn't built for mobile. At all. We couldn't even mark the cards red
            or blue. So what did we do? We grabbed post-it notes and started slapping them on the TV
            like cavemen. Honestly? Everyone still had a blast. And of course, we wanted to play
          ...
          <p>
            ...
            The twist? I did it entirely on my iPhone. Forked the repo, edited code through GitHub's
            web interface, deployed to Netlify, and hooked it up to my domain &mdash; all from my
            phone. No laptop, no desktop, just me, my phone, and pure stubbornness. Did this after
            shooting water guns in the pool with the kids, and still had plenty of time to enjoy the
            rest of the day before evening game night. It was painful, but I got it working well
            enough to play without post-it notes for the rest of the trip.
          </p>
          <p>
          ...
          <p>
            Over time, I kept tinkering. I made my own UI/UX choices to make things easier and more
            fun when friends and family play together. Eventually, I did a complete rewrite in Vue
            and Vite &mdash; nothing against React, I just prefer working with Vue.
          </p>
          <p>
            The best part? Hearing ideas, bugs, and suggestions from the people who actually play.
            There's something special about building something that brings people together for game
            night.
          </p>
